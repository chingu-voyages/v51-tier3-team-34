...
const Profile = () => {
  ...
  const completedAmt = (type) => {
    const filteredArray = currentUser.completed.filter((completed) =>
      completed.startsWith(type),
    );
        ...
        <div className="right-section">
          ...
          <div className="points-info">
            <div>
              ...
              <p>
                <span>Total Points Earned: </span> {currentUser.points}
              </p>
            </div>
            <div>
              <img src={quiz} alt="quiz-icon" />
              <p>
                <span>Total Quizzes Completed: </span> {completedAmt("q")}
              </p>
            </div>
            <div>
              <img src={map} alt="map-icon" />
              <p>
                <span>Total Scavenger Hunt Completed: </span>{" "}
                {completedAmt("s")}
              </p>
            </div>
          </div>
          ...
          <div className="achievement-section">
            ...
            <div className="tracking">
              ...
              {badge === explorerGold ? (
                <p>Congratulations for reaching the Gold Explorer Badge!</p>
              ) : (
                <p>{pointsDiff} more points to the next badge. </p>
              )}
            </div>
