const landmarks = [
  {
    ...
    location: {
      lat: 38.149784605860276,
      lng: -84.51978347606371,
    },
    description:
      "Kentucky Horse Park is a working horse farm, international equestrian competition venue, and an educational theme park opened in 1978 in Lexington. Set on more than 1,200 acres in the heart of the Kentucky's famous Bluegrass region, the park is THE place to get close to horses! Additionally, the park contains the International Museum of the Horse, which has a permanent collection of horse history and memorabilia, along with a rotating historical collection focused on a particular theme.",
    icontype: "default",
    imgUrl: "",
  },

  {
    ...
    location: {
      lat: 38.05144149355575,
      lng: -84.50273800310349,
    },
    description:
...

  {
    ...
    location: {
      lat: 38.00726184402106,
      lng: -84.59917364543452,
    },
    description:
...

  {
    ...
    location: {
      lat: 38.028729196789534,
      lng: -84.48008103009204,
    },
    description:
...

  {
    ...
    location: {
      lat: 37.81954745471773,
      lng: -84.73830379258531,
    },
    description:
...

  {
    name: "Gratz Park",
    location: {
      lat: 38.050750150860516,
      lng: -84.4948274278911,
    },
    description:
...

  {
    name: "Loudoun House",
    location: {
      lat: 38.05553707289051,
      lng: -84.47607601844499,
    },
    description:
      "The Loudon House is one of only five remaining castellated Gothic Revival villas in the entire nation. The villa, which is on the National Register of Historic Places, was built in 1850 by New York architect A.J. Davis for Francis Key Hunt. Today, this building is home to the esteemed Lexington Art League.",
    icontype: "default",
    imgUrl: "",
  },

  {
    ...
    location: {
      lat: 38.04996710864296,
      lng: -84.49915368225255,
    },
    description:
      " The Lexington Opera House was built in 1886 by architect Oscar Cobb, and now hosts a variety of performing arts events. Interestingly, it is one of only 14 theaters in the country built before 1900 that is still in operation and has less than 1,000 seats.",
    icontype: "default",
    imgUrl: "",
  },

  {
    ...
    location: {
      lat: 38.031179636130716,
      lng: -84.50383673726141,
    },
    description:
      "Founded in 1865, the University of Kentucky is the largest public university in the state, educating more than 24,000 students each semester.",
    icontype: "default",
    imgUrl: "",
  },
];
